...
public class DialogUpgradeVersion extends Dialog {
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(com.jkcq.managersetting.R.layout.dialog_yesorno, null);
        setContentView(view);
        setCancelable(false);
...
//        lp.height=LinearLayout.LayoutParams.WRAP_CONTENT;
       /* int width = (int) (ScreenUtils.getScreenWidth() * 0.4);
        ...
        int width = (int) (mContext.getResources().getDimension(com.jkcq.hrwtv.base.R.dimen.dialog_yes_with));
        int height = (int) (mContext.getResources().getDimension(com.jkcq.hrwtv.base.R.dimen.dialog_yes_height));
        lp.width = width; // 宽度
        lp.height = height; // 高度
